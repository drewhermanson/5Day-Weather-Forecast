...
var displayWeather = function(weather){
   ...
   //variable for current days weather data
    ...
    //bootstrap class for card headers. the slightly darker division in the card
    ...
    //these 3 lines add an img tag with the src html of currentIconUrl(sun,cloudy,rainy icons) and appends it to the body div
    var currentIconEl = document.createElement('img');
    currentIconEl.setAttribute('src', currentIconUrl);
    currentBodyEl.appendChild(currentIconEl);

    //lines 153-166 create paragraph tags, with a bootstrap class that determines text styling, and adds the temperature, humdidity, and wind speed to the card body
    ...
    for (var i = 1; i < 6; i++) {
        ...
        //211-219 add paragraph tags to the card body with the temperature and humidity on that day. Also adds the bootstrap class card text.
